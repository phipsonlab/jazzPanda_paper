...
jpeg(file.path(figure_result, "figure3d_cosmx_hhliver_stellate_xy.jpg"),
...
jpeg(file.path(figure_result, "figure3e_cosmx_hhliver_top1_xy_perm.jpg"),
     height = 1000, width = 1100, res=200)
p1
...
pdf(file.path(figure_result, "figure3f_cosmx_hhliver_top1_perm_vvplot.pdf"),
    height = 5, width = 5)
p
dev.off()
