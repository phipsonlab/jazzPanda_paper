...
#SBATCH --job-name=run_mg_xenium_human_lung_cancer_5core
#SBATCH --output=slurm_workflowr/mg_xenium_human_lung_cancer_5core.out
#SBATCH --error=slurm_workflowr/mg_xenium_human_lung_cancer_5core.err
...
/usr/bin/time -v Rscript mg_xenium_human_lung_cancer.R
rm -rf  $TMPDIR
