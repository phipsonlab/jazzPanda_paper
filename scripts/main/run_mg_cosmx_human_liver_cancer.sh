...
#SBATCH --job-name=run_mg_cosmx_human_liver_cancer_5core
#SBATCH --output=slurm_workflowr/mg_cosmx_human_liver_cancer_5core.out
#SBATCH --error=slurm_workflowr/mg_cosmx_human_liver_cancer_5core.err
...
/usr/bin/time -v Rscript mg_cosmx_human_liver_cancer.R
rm -rf  $TMPDIR
