...
#SBATCH --job-name=run_gene_count_frequency
#SBATCH --output=slurm_out/run_gene_count_frequency.out
#SBATCH --error=slurm_out/run_gene_count_frequency.err
...
/usr/bin/time -v Rscript per_sample_gene_count_frequency.R
rm -rf  $TMPDIR
