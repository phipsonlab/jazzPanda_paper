...
#SBATCH --job-name=run_mg_xenium_mbrain_5core
#SBATCH --output=slurm_workflowr/mg_xenium_mouse_brain_5core.out
#SBATCH --error=slurm_workflowr/mg_xenium_mouse_brain_5core.err
...
/usr/bin/time -v Rscript mg_xenium_mouse_brain.R
rm -rf  $TMPDIR
