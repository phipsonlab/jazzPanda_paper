...
pdf(file.path(figure_compare_methods, "cosmx_hhliver_upset.pdf"),height=6, width=18)
print(combined_plot)
dev.off()
################################################################################
...
combined_plot <- wrap_plots(plot_lst, ncol = 3)
pdf(file.path(figure_compare_methods, "cosmx_hhliver_rank_ma.pdf"), height=5, width=15)
print(combined_plot)
dev.off()
...
combined_plot <- wrap_plots(plot_lst, ncol = 3)
pdf(file.path(figure_compare_methods, "xenium_hbreast_upset.pdf"), height=6, width=18)
print(combined_plot)
dev.off()
################################################################################
...
combined_plot <- wrap_plots(plot_lst, ncol = 3)
pdf(file.path(figure_compare_methods, "xenium_hbreast_rank_ma.pdf"), height=5, width=15)
print(combined_plot)
dev.off()