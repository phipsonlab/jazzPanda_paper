---
title: "CosMx human liver cancer - simulation"
author: "Melody"
date: "2024-08-05"
...
pdf(paste(PA, "figure4_cosmx_hlc_correlation.pdf", sep=""), width=8, height=4)
p1
dev.off()
```
...
pdf(paste(PA, "rank_p_value_heatmap.pdf"), width=8,height=5)
