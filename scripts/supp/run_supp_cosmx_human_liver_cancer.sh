...
#SBATCH --job-name=supp_cosmx_hlc
#SBATCH --output=slurm_out/supp_cosmx_hlc.out
#SBATCH --error=slurm_out/supp_cosmx_hlc.err
...
/usr/bin/time -v Rscript -e "rmarkdown::render('supplementary_application_cosmx_human_liver_cancer.Rmd', output_format = 'html_document')"
rm -rf  $TMPDIR
