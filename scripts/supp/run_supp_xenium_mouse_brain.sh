...
#SBATCH --job-name=supp_xenium_mouse_brain
#SBATCH --output=slurm_out/supp_xenium_mouse_brain.out
#SBATCH --error=slurm_out/supp_xenium_mouse_brain.err
...
/usr/bin/time -v Rscript -e "rmarkdown::render('supplementary_application_xenium_mouse_brain.Rmd', output_format = 'html_document')"
rm -rf  $TMPDIR
