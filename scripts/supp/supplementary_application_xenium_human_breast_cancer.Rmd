...
nc_coords_sp1 <- sp1$trans_info[sp1$trans_info$feature_name %in% c(sp1$probe, sp1$codeword),
                                c("x", "y", "feature_name")]
nc_coords_sp2 <- sp2$trans_info[sp2$trans_info$feature_name %in% c(sp2$probe, sp2$codeword), 
                                c("x", "y", "feature_name")]
nc_coords = as.data.frame(rbind(cbind(nc_coords_sp1, sample= "sample1"), 
                                cbind(nc_coords_sp2, sample= "sample2"))
                          )
nc_coords$category = "negative control probe"
nc_coords[nc_coords$feature_name %in% c(sp1$codeword,sp2$codeword), "category"] = "negative control codeword"
...
jpeg(file.path(overview_PA, paste0(data_nm, "_nc_xy.jpg")), 
     width=700*2, height=500*2, res=200)
