...
anno_df <- data.frame(
  ...
  major_class = c(
    "Epithelial","Stromal","Epithelial","Epithelial","Epithelial","Epithelial",
    "Immune","Epithelial","Immune","Epithelial","Immune","Immune","Epithelial",
    "Stromal","Immune","Immune"
  ),
  sub_class = c(
    "Tumor epithelial","Fibroblast (CAF)","Tumor epithelial","Tumor epithelial",
    "Tumor epithelial (IFN/MHC-II+)","Tumor epithelial (cycling)",
    "Myeloid (Macrophage/TAM)","Tumor epithelial (cycling)",
    "Myeloid (Macrophage/TAM)","Tumor epithelial","Myeloid (Mono→MΦ)",
    "T/NK","Tumor epithelial","Endothelial","B lineage","Dendritic cell"
  ),
  cell_type = c(
    "WNT/ERBB-active luminal-progenitor–like",
    "Myofibroblastic CAF (myCAF)",
    "Basal/EMT-high invasive",
    "G2/M cycling carcinoma",
    "Antigen-presenting tumor epithelial (AP-TEC)",
    "S-phase/replication-high carcinoma",
    "SPP1+ inflammatory TAM",
    "G2/M hyper-proliferative/stem-like",
    "C1QC+/MRC1+ immunoregulatory TAM",
    "Stress/EMT/stem-like (ERBB/LGR5/SOD2)",
    "FCGR3A+ inflammatory monocyte/macrophage",
    "Activated TILs (mixed CD8+/Th1; partial exhaustion/Treg admixture)",
    "Inflammatory/hypoxic (COX-2/PTGS2+)",
    "Angiogenic/tip endothelium",
    "Plasma cell",
    "Langerhans-like / cDC2-skewed DC"
  ),
  supporting_genes = c(
    "DKK1, EPHB3, ERBB2/3, FGFR2, LRP6, EPCAM, LGR5",
    "COL1A1, COL11A1, COL6A3, ACTA2, FN1, FAP, PDGFRA/B, TNC",
    "MMP7, LAMC2, LAMB3, SOD2, SOX9, EPCAM",
    "MCM2, PCNA, PLK1, BIRC5, MYBL2, FOXM1, EPCAM",
    "HLA-DRA/DRB1/DPA1, CIITA, TAP1/2, EPCAM, ERBB2/3",
    "MKI67, PCNA, CCNE1, CDK4/6, AURKA/B, BIRC5, MYBL2",
    "SPP1, MMP9/12, CXCL8, VEGFA, ITGAX, IL1B, MARCO",
    "FOXM1, BIRC5, PLK1, MKI67, AURKA/B, SOX2",
    "C1QC, MRC1, CD163, CSF1R, CD14, CD209",
    "SOD2, MMP7, SOX9, LGR5, FGFR2, ICAM1, VEGFA",
    "LYZ, FCGR3A, ITGB2, CYBB, CCR1, CCL2, MSR1, TREM2",
    "TRAC, CD3E/D/G, CD8A, GZMA/H, CCL5, CXCR3, TIGIT, LAG3, PDCD1, FOXP3",
    "PTGS2, VEGFA, ICAM1, MMP7, LAMC2/LAMB3, MUC1",
    "PECAM1, VWF, KDR/FLT1, FLT4, PLVAP, CLDN5, ANGPT2, MMRN2, PGF",
    "XBP1, MZB1, IRF4, POU2AF1, CD79A/B, TNFRSF13C",
    "CD207, FCER1A, CD1C/B/E, CCL22, LAMP3, CX3CR1"
  ),
  notes = c(
    "Epithelial RTK/WNT program; stem-like cues; non-cycling.",
    "Highly concordant ECM/myofibroblast signature across methods.",
    "Invasive/EMT markers with epithelial core; not strongly cell-cycle.",
    "Robust proliferative program; epithelial identity retained.",
    "Clear CIITA/MHC-II induction in carcinoma cells.",
    "FM shows strong S-phase; jazzPanda sparse likely coverage.",
    "Inflammatory/angiogenic TAM subtype distinct from C1QC+ state.",
    "Mitotic peak with SOX2; minor immune transcripts likely bleed-through.",
    "Regulatory/resident TAM program; distinct from inflammatory TAMs.",
    "Oxidative stress + EMT/stem features; epithelial confirmed.",
    "Mono-derived activation; distinct from TAM states in c6/c8.",
    "Mixture of CD8+, Th1, Treg and exhaustion markers—heterogeneous TILs.",
    "COX-2/hypoxia/inflammation in epithelium; weaker specificity than c4.",
    "Canonical endothelial with tip/angiogenic features.",
    "Textbook plasma-cell program; very strong.",
    "Langerin+ with cDC2 features; likely migratory LAMP3+ DC admixture."
  ),
  confidence = c(
...
anno_name = c("Tumor-LP/WNT",
                "CAF-myCAF", 
                "Tumor-Basal/EMT",
                "Tumor-Luminal/Cycling",
                "Tumor-MHCII+",
                "Tumor-G2M",
                "TAM (SPP1+)",
                "Cycling carcinoma",
                "TAM-C1QC/M2",
                "EMT/stress carcinoma",
                "TAM-CD16/TREM2",
                "Tcell-Mixed",
                "Tumor-Inflam/Hypoxia",
